...
function updateActivity(activity) {
  ...
  if (activity === 'activeMinutes') {
    activityOrbit.sweepAngle = 360 * Math.min(today.adjusted.activeZoneMinutes.total, goals.activeZoneMinutes.total) / goals.activeZoneMinutes.total;
  } else {
